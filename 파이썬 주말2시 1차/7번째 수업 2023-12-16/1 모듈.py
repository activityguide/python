...
import converter
miles = converter.kilometer_to_miles(150) # 모듈 함수, 함수() 형식으로 호출
print(f'150km = {miles}miles') # 150km = 93.20565miles

pounds = converter.gram_to_pound(1000)
print(f'1000g = {pounds}pounds') # 1000kg = 2.205pounds
...
from converter import * # 모듈을 사용하지 않고 모듈의 모든 함수를 가져온다
pounds = gram_to_pound(10000)
print(f'10000g = {pounds}pounds')
...
pounds = cvt.gram_to_pound(1000)
print(f'1000g = {pounds}pounds')

print()

from converter import kilometer_to_miles as k_to_m # 함수에도 별명 지정가능
miles = k_to_m(150)
print(f'150km = {miles}miles')
